 ...
 *         for adding and removing centre 
 * Version 1.0 
...
public class DiagnosticCentreDao implements DiagnosticCentreDaoInterface {
	...
	/************************************************************************************
	 * Method: addCentre Description: To add centre in diagnostic centre
	 * 
	...
	/************************************************************************************
	 * Method: deleteCentre Description: To delete centre in diagnostic centre
	 * 
	...
	/************************************************************************************
	 * Method: updateCentre Description: To update centre in diagnostic centre
	 * 
	...
	/************************************************************************************
	 * Method: getCentre Description: To fetch the centre made by admin
	 * 
	...
	public DiagnosticCentre getCentre(long centreId) throws CentreException {
		...
		if (diagnosticCentre == null)
			throw new CentreException("Centre Id does not exist for " + centreId);
	...
	/************************************************************************************
	 * Method: viewCentreById Description: To fetch the centreId made by admin
	 * 
	 * @param viewCentreById Fetches all centre present
	 * @throws CentreException It is raised due to centre id does not exist
	 ************************************************************************************/
