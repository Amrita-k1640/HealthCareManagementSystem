...
public class HealthCareSystemService implements HealthCareSystemServiceInterface {
	...
	/************************************************************************************
	 * Method: viewAppointment Description: To view appointment made by user
	 * 
...
//		// TODO Auto-generated method stub
//		DiagnosticCentre cent = cdao.getCentre(appointment.getCentreId());
//		Appointment obj = new Appointment(appointment.getAppointmentId(), cent);
//
//		if (adao.bookAppointment(obj))
//			return true;
//		else
...
//	}
	...
	public void approveAppointment(long appointmentId, boolean approvalStatus) {
		// TODO Auto-generated method stub		
		adao.approveAppointment(appointmentId, approvalStatus);
	...
	/************************************************************************************
	 * Method: viewUser Description: To view user registered
	 * 
	...
	/************************************************************************************
	 * Method: Test Description: To add,remove and display test
	 * 
	...
	/************************************************************************************
	 * Method: Centre Description: To add,remove and display centre
	 * 
