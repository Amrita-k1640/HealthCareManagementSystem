...
export class AdminserviceService {
  ...
  public getCentre(): Observable<any> {
    ...
    return this.http.get("http://localhost:8020/getCentre");
  }
  ...
  public addCentre(centre: DiagnosticCentre): Observable<any> {
    ...
    return this.http.post("http://localhost:8020/addCentre", centre, { responseType: 'text' });
  }
  ...
  public deleteCentre(centreId: number): Observable<any> {
    ...
    return this.http.delete<DiagnosticCentre>("http://localhost:8020/deleteCentre" + "/" + centreId);
  }
  ...
  public updateCentre(centre: DiagnosticCentre): Observable<any> {
    ...
    return this.http.put<DiagnosticCentre>("http://localhost:8020/updateCentre/" + end, centre);
  }
  ...
  public findById(centreId: number): Observable<any> {
    ...
    let endpoint = centreId
    return this.http.get("http://localhost:8020/viewcentrebyid/" + endpoint, httpOptions);
  }
  ...
  public getTest(): Observable<any> {
    ...
    return this.http.get("http://localhost:8020/getTest");
  }
  ...
  public addTest(test: Test): Observable<any> {
    ...
    return this.http.post("http://localhost:8020/addTest", test, { responseType: 'text' });
  }
  ...
  public deleteTest(testId: number): Observable<any> {
    ...
    let endpoint = testId;
    return this.http.delete<Test>("http://localhost:8020/deleteTest/" + endpoint);
  }
  ...
  public getAppointment(): Observable<any> {
    ...
    return this.http.get("http://localhost:8020/getAppointment");
  }


  public approveAppointment(appointmentId: number): Observable<any> {
    console.log("updated");
    let end = appointmentId;
    return this.http.put<Appointment>("http://localhost:8020/approveAppointment/" + end, appointmentId);
  }
  ...
  public getUser(): Observable<any> {
    ...
    return this.http.get("http://localhost:8020/getUser");
  }
